...
load projected_retreat_MEC.mat 
...
for l=1:7,
    ...
    % ACCESS RCP8.5
    plot(t,retreat.NorESM2LM.B1500r02.high(l,:),'color',cols(1,:),'linewidth',lwthick);
    plot(t,retreat.NorESM2LM.B1500r02.med(l,:),'color',cols(1,:),'linewidth',lwthick);
    plot(t,retreat.NorESM2LM.B1500r02.low(l,:),'color',cols(1,:),'linewidth',lwthick); 

    xlim([1850 2250]); ylim([-45 5]);
...
dy = 0.04;
fs0 = 4;
annotation('textbox','position',[tx,ty+1*dy,0,0],'string','B1500r02','fontsize',fs0,'interpreter','latex','edgecolor','none','color',cols(1,:));

saveplot(17,8,300,'retreat_projections_MEC.png');
close all;
...
for l=1:7,
    ...
    axes(a(l)); hold on;
    plot(t,retreat.NorESM2LM.B1500r02.TF(l,:),'color',cols(1,:),'linewidth',lwthick);

    xlim([1850 2250]); ylim([1 11]);
    set(gca,'fontsize',fs,'box','on');
...
dy = 0.03;
fs = 5;
annotation('textbox','position',[tx,ty-1*dy,0,0],'string','NorESM2LM-B1500r02','fontsize',fs,'interpreter','latex','edgecolor','none','color',cols(1,:));

saveplot(17,8,300,'TF_projections_MEC.png');
close all;
