...
% load glaciers
load ../glaciers/glaciers_RACMO23p2.mat
...
% mm = 2 for CESM2-CMIP6 ssp585
% mm = 3 for CESM2-CMIP6 ssp585
...
% CESM2 ssp245
retreat.CESM2CMIP6.ssp245.p95 = squeeze(Rp95(2,:,:));
retreat.CESM2CMIP6.ssp245.low = squeeze(Rlow(2,:,:));
retreat.CESM2CMIP6.ssp245.med = squeeze(Rmed(2,:,:));
retreat.CESM2CMIP6.ssp245.high = squeeze(Rhigh(2,:,:));
retreat.CESM2CMIP6.ssp245.p05 = squeeze(Rp05(2,:,:));
% CESM2 ssp126
retreat.CESM2CMIP6.ssp126.p95 = squeeze(Rp95(3,:,:));
retreat.CESM2CMIP6.ssp126.low = squeeze(Rlow(3,:,:));
retreat.CESM2CMIP6.ssp126.med = squeeze(Rmed(3,:,:));
retreat.CESM2CMIP6.ssp126.high = squeeze(Rhigh(3,:,:));
retreat.CESM2CMIP6.ssp126.p05 = squeeze(Rp05(3,:,:));
...
save projected_retreat_RACMO23p2.mat retreat

%% plot results
if (plot_flg)
    plot_projections_RACMO23p2
end
