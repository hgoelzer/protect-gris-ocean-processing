...
load projected_retreat_SDBN1.mat 
...
for l=1:7,
    ...
    % CESM2 ssp585
    plot(t,retreat.CESM2WACCM.ssp585.high(l,:),'color',cols(2,:),'linewidth',lwthick);
    plot(t,retreat.CESM2WACCM.ssp585.med(l,:),'color',cols(2,:),'linewidth',lwthick);
    plot(t,retreat.CESM2WACCM.ssp585.low(l,:),'color',cols(2,:),'linewidth',lwthick); 

    plot(t,retreat.CESM2WACCM.ssp126.high(l,:),'color',cols(2,:),'linewidth',lwthick);
    plot(t,retreat.CESM2WACCM.ssp126.med(l,:),'color',cols(2,:),'linewidth',lwthick);
    plot(t,retreat.CESM2WACCM.ssp126.low(l,:),'color',cols(2,:),'linewidth',lwthick); 
...
dy = 0.04;
fs0 = 4;
annotation('textbox','position',[tx,ty+2*dy,0,0],'string','CESM2WACCM-ssp585','fontsize',fs0,'interpreter','latex','edgecolor','none','color',cols(1,:));
annotation('textbox','position',[tx,ty+2*dy,0,0],'string','CESM2WACCM-ssp126','fontsize',fs0,'interpreter','latex','edgecolor','none','color',cols(2,:));

saveplot(17,8,300,'retreat_projections_SDBN1.png');
close all;
...
for l=1:7,
    ...
    axes(a(l)); hold on;
    plot(t,retreat.CESM2WACCM.ssp585.TF(l,:),'color',cols(1,:),'linewidth',lwthick);
    plot(t,retreat.CESM2WACCM.ssp126.TF(l,:),'color',cols(2,:),'linewidth',lwthick);
...
dy = 0.03;
fs = 5;
annotation('textbox','position',[tx,ty-2*dy,0,0],'string','CESM2WACCM-ssp585','fontsize',fs,'interpreter','latex','edgecolor','none','color',cols(1,:));
annotation('textbox','position',[tx,ty-2*dy,0,0],'string','CESM2WACCM-ssp126','fontsize',fs,'interpreter','latex','edgecolor','none','color',cols(2,:));

saveplot(17,8,300,'TF_projections_SDBN1.png');
close all;
